    ...
    <div class="card-body">
        <form action="{{ route('users.store') }}" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-12" id="modules-section" style="display:none;">
                                ...
                                <div class="col-md-4">
                                    <div class="form-check form-check-inline border rounded p-2 w-100">
                                        <input class="form-check-input" type="checkbox"
                                               name="modules_actifs[]"
                                               id="module_create_{{ $key }}"
                                               value="{{ $key }}"
                                               {{ in_array($key, old('modules_actifs', ['accident','infraction','immigration'])) ? 'checked' : '' }}>
                                        <label class="form-check-label fw-semibold" for="module_create_{{ $key }}">
